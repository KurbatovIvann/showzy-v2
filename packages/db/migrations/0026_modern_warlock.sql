...
ALTER TABLE "company_customer_invite_redemptions" ADD CONSTRAINT "company_customer_invite_redemptions_company_customers_company_fk" FOREIGN KEY ("company_id","company_customer_id") REFERENCES "public"."company_customers"("company_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
