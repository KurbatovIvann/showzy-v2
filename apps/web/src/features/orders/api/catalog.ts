...
export function catalogListProductsQueryKey(companyId: string) {
...
export function catalogListProductsQueryOptions(args: {
  ...
  return {
    ...contractQueryOptions({
      ...
      companyId,
      input: ORDER_PRODUCT_LOOKUP_INPUT,
      getActiveCompany: () => args.client.getActiveCompany(),
      queryFn: () =>
        args.client.client.catalog.listProducts(ORDER_PRODUCT_LOOKUP_INPUT),
    }),
