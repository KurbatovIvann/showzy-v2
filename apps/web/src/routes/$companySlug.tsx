 ...
 * via `companies.listMine`, sets `x-company-id`, and guards the session
 * (ADR-0030) — that arrives with the company-scope web ticket. The slug
 * is a display selector, never an access grant (ADR-0013).
 */
