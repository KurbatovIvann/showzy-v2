/**
 * Per-id CRM hydration for orders list and detail (SHO-211 / SHO-212).
 * Pending and non-NOT_FOUND query failures are not "deleted" — only a
 * null customerId, settled NOT_FOUND, or a blank name maps to
