/**
 * Dirty-leave for the product form (SHO-159). Product-local: dirty includes
 * photos. Do not hoist to a generic navigator guard in this ticket.
 */
...
export function useUnsavedProductGuard(args: {
