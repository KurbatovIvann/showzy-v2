 ...
 * labels (list/aggregate rows, HITL actions) resolve against a bounded
 * parent. Yoga shrink-wraps `maxWidth` + `alignItems: flex-start` with
 * no `width` to the child's intrinsic size → width 0 on those labels.
