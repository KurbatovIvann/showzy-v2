/**
 * Dirty-leave for the customer form (SHO-180). Customer-local: dirty is
 * RHF only. Do not hoist to a generic navigator guard in this ticket.
 */
...
export function useUnsavedCustomerGuard(args: {
