...
| `shared/`         | Permissions, hrefs, caps, initials, count labels, protocol-confirm helper, paged-list helpers, lookup drain, entity card chrome, `OptionSelectSheet`, `SelectorRow`                                                                                                                           | Transport                                                         |
