...
The running design system is Expo Unistyles:

- tokens: `apps/mobile/src/theme/tokens.ts`
- primitives: `apps/mobile/src/components/ui/`
- how to map a canvas screen: [`docs/design/mapping/mp-to-mobile.md`](../mapping/mp-to-mobile.md)

The Magic Patterns canvas is the prototype to read. It is not a second
