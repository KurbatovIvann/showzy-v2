-- ============================================================================
-- Migration: process_mono_acquiring_webhook
-- Description: Atomic PostgreSQL function for processing Monobank Acquiring
--              webhooks. Replaces multi-step individual DB writes with a
--              single transactional RPC call. Service role only.
-- Dependencies: mono_acquiring_invoices, payments, orders
-- ============================================================================
...
comment on function process_mono_acquiring_webhook(text, text, integer, jsonb, jsonb, text, text, text) is
	'Atomically processes a Monobank Acquiring webhook: updates invoice, handles payment creation/update, and updates order status. Service role only.';
